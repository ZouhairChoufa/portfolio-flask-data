...
// Fonction pour charger le badge LinkedIn dynamiquement
function loadLinkedInBadge() {
    ...
    // Créer le HTML du badge avec le bon thème
    container.innerHTML = `
        <div class="badge-base LI-profile-badge" data-locale="fr_FR" data-size="large" data-theme="${theme}" data-type="HORIZONTAL" data-vanity="zouhair-choufa" data-version="v1">
          <a class="badge-base__link LI-simple-link" href="https://www.linkedin.com/in/zouhair-choufa/">Zouhair Choufa</a>
        </div>
    `;

    // Forcer le rechargement du script LinkedIn
    const oldScript = document.getElementById('li-script');
...
document.addEventListener('DOMContentLoaded', loadLinkedInBadge);

// Mettre à jour le badge quand on clique sur le bouton de thème
const themeToggleBtn = document.getElementById('theme-toggle');
if (themeToggleBtn) {
    themeToggleBtn.addEventListener('click', () => {
        // On attend un court instant que la classe 'light' soit ajoutée au HTML
        setTimeout(loadLinkedInBadge, 100);
    });
}